...
export default function Product_Navigation() {
  ...
  return (
    <Disclosure as="nav" className="bg-sea-green">
      {({ open }) => (
        <>
              ...
              <div className="flex flex-1 items-center justify-between  sm:justify-between">
                <div className="flex flex-shrink-0 items-center">
                  {/* <img
                    ...
                    alt="Your Company"
                  /> */}
                  <h6 className='text-red-400 text-xl '>Cycloop</h6>
                </div>
            ...
            <div className="space-y-1 px-2 pb-3 pt-2 ">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'text-black' : 'text-white  hover:text-grey',
