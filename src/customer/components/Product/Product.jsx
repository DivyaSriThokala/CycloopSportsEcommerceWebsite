    ...
    return (
        ...
        <div className="bg-white">
            ...
            <div>
                ...
                <main className="mx-20 max-w-7xl px-1 sm:px-6 lg:px-8">
                    <div className="flex items-baseline justify-between border-b border-gray-200  pt-24">
                        <div className='flex pt-0'>
                            ...
                            <div className='pb-0'>
                                <h1 className="text-2xl font-bold pl-5 pb-2 tracking-tight text-gray-900">Filters</h1>
                            </div>
                                            ...
                                            <>
                                                ...
                                                <Disclosure.Panel className="pt-6">
                                                    <div className="space-y-4">
                                                        {section.options.map((option, optionIdx) => (
                                                            <div key={option.value} className="flex items-center">
                                                                <input onChange={() => handleFilter(option.value, section.id)}
